...
@Component
public class MonedaDialog extends JDialog {
	...
	private MonedaInterfaz interfaz;
	
	private List<Moneda> monedas;

	@Autowired
	public MonedaDialog(MonedaService service, MonedaTableModel tableModel) {
	...
	public MonedaInterfaz getInterfaz() {
		return interfaz;
	}
	
	public void setInterfaz(MonedaInterfaz interfaz) {
		this.interfaz = interfaz;
	}
	
	private void aceptar() {
		for (Integer c : table.getSelectedRows()) {
			interfaz.getEntity(monedas.get(c));         
	    }
		dispose();
	}
