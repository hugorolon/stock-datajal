...
@Component
public class CondicionPagoDialog extends JDialog {
	...
	private CondicionPagoInterfaz interfaz;
	
	private List<CondicionPago> condiciones;

	@Autowired
	public CondicionPagoDialog(CondicionPagoService service, CondicionPagoTableModel tableModel) {
		this.service = service;
		this.tableModel = tableModel;
		
		this.setTitle("Buscador de Condiciones de Pago");
	...
	public CondicionPagoInterfaz getInterfaz() {
		return interfaz;
	}
	
	public void setInterfaz(CondicionPagoInterfaz interfaz) {
		this.interfaz = interfaz;
	}
	
	private void aceptar() {
		for (Integer c : table.getSelectedRows()) {
			interfaz.getEntity(condiciones.get(c));         
	    }
		dispose();
	}
