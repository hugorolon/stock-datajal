...
import py.com.prestosoftware.ui.table.PagarProveedorTableModel;
...
@Component
public class PagarProveedorDialog extends JDialog {
	...
	private PagarProveedorService service;
	private PagarProveedorTableModel tableModel;
	private PagarProveedorInterfaz interfaz;
	
	private List<PagarProveedor> ingresos;

	@Autowired
	public PagarProveedorDialog(PagarProveedorService service, PagarProveedorTableModel tableModel) {
		...
		tfBuscador.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					loadPagarProveedors(tfBuscador.getText().isEmpty() ? "" : tfBuscador.getText());
				}
	...
	public void loadPagarProveedors(String name) {
		ingresos = service.findByFecha();
		tableModel.clear();
        tableModel.addEntities(ingresos);
    }
	
	public PagarProveedorInterfaz getInterfaz() {
		return interfaz;
	}
	
	public void setInterfaz(PagarProveedorInterfaz interfaz) {
