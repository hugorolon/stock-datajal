...
@Component
public class PresupuestoPanel extends JFrame implements ClienteInterfaz, 
	VendedorInterfaz, ProductoInterfaz, PresupuestoInterfaz {
...
//	private static final int DEPOSITO_CODE = 3;
    ...
    public PresupuestoPanel(
    	PresupuestoTableModel itemTableModel, ClienteDialog clientDialog, VendedorDialog vendedorDialog,
		ProductoDialog productoDialog, PresupuestoValidator ventaValidator, 
...
//        calculateVencimiento();
    ...
    private void initComponents() {
    	...
    	tabbedPane.setBounds(9, 129, 888, 325);
        ...
        scrollProducto.setBounds(6, 81, 855, 186);
...
//        pnlProducto.add(cbListPrecio);
        ...
        panel_3.setBounds(9, 12, 888, 105);
...
//        pnlCliente.add(label_3);
        ...
        pnlBotonera.setBounds(9, 544, 888, 35);
        ...
        pnlTotales.setBounds(9, 483, 888, 49);
...
//        	}
//        });
//        tfCondPago.setBounds(95, 46, 55, 30);
//        pnlTotales.add(tfCondPago);
...
//        	public void keyPressed(KeyEvent e) {
//        		if (e.getKeyCode() == KeyEvent.VK_ENTER) {
//        			Double subtotal = tfSubtotal.getText().isEmpty() ? 0 : Double.valueOf(tfSubtotal.getText());
...
//        	public void keyPressed(KeyEvent e) {
//        		if (e.getKeyCode() == KeyEvent.VK_ENTER) {
//        			Double subtotal = tfSubtotal.getText().isEmpty() ? 0 : FormatearValor.stringToDouble(tfSubtotal.getText());
//        			setTotals(0d, subtotal);
...
//		tfSubtotal.setText(String.valueOf(p.getTotalGravada10()));
		tfTotal.setText(String.valueOf(p.getTotalGeneral()));
