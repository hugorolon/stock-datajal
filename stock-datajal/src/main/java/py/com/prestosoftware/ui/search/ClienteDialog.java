...
public class ClienteDialog extends JDialog {
	...
	@Autowired
	public ClienteDialog(ClienteService service, ClientTableModel tableModel) {
		this.service = service;
		this.tableModel = tableModel;
		
		this.setTitle(ResourceBundle.getBundle("py.com.prestosoftware.ui.search.messages").getString("ClienteDialog.this.title")); //$NON-NLS-1$ //$NON-NLS-2$
