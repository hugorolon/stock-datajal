...
import py.com.prestosoftware.ui.table.IngresoTableModel;
...
@Component
public class IngresoDialog extends JDialog {
	...
	private IngresoTableModel tableModel;
	private IngresoInterfaz interfaz;
	
	private List<Ingreso> ingresos;

	@Autowired
	public IngresoDialog(IngresoService service, IngresoTableModel tableModel) {
		...
		tfBuscador.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					loadIngresos(tfBuscador.getText().isEmpty() ? "" : tfBuscador.getText());
				}
	...
	public IngresoInterfaz getInterfaz() {
		return interfaz;
	}
	
	public void setInterfaz(IngresoInterfaz interfaz) {
