...
public class HistoricoCompra extends JDialog {
	...
	@Autowired
	public HistoricoCompra(ProductoService service, ProductTableModel tableModel) {
		...
		lblPeso = new JLabel("NOTA, COD. PROVEEDOR, PROVEEDOR, COSTO FOB, COSTO CIF, CANTIDAD");
