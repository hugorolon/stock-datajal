...
@Component
public class CiudadValidator extends ValidationSupport implements Validator<Ciudad> {

    private static final String REQUIRED_DATA_NOT_FILLED_OR_BAD_DATA = "Campos Obligatorios";

    @Override
    public Optional<ValidationError> validate(Ciudad ciudad) {
        if (isNullOrEmptyString(ciudad.getNombre())) {
