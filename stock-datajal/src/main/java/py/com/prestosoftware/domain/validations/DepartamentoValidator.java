...
@Component
public class DepartamentoValidator extends ValidationSupport implements Validator<Departamento> {

    private static final String REQUIRED_DATA_NOT_FILLED_OR_BAD_DATA = "Campos Obligatorios";

    @Override
    public Optional<ValidationError> validate(Departamento dep) {
